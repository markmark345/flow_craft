...
func (r *RunStepRepository) CreateMany(ctx context.Context, steps []domain.RunStep) error {
	if len(steps) == 0 {
		return nil
	}
...
func (r *RunStepRepository) ListByRunID(ctx context.Context, runID string) ([]domain.RunStep, error) {
...
func (r *RunStepRepository) Get(ctx context.Context, runID string, stepIDOrKey string) (*domain.RunStep, error) {
	var step domain.RunStep
	var nodeID sql.NullString
	var nodeType sql.NullString
	var inputs []byte
