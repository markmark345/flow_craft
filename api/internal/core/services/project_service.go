...
func (s *ProjectService) List(ctx context.Context, user domain.AuthUser) ([]domain.Project, error) {
	return s.projects.ListByUser(ctx, user.ID)
}

func (s *ProjectService) Get(ctx context.Context, user domain.AuthUser, projectID string) (*domain.Project, error) {
	return s.projects.GetForUser(ctx, projectID, user.ID)
}

func (s *ProjectService) Create(ctx context.Context, user domain.AuthUser, name string, description string) (domain.Project, error) {
...
func (s *ProjectService) requireAdmin(ctx context.Context, projectID string, user domain.AuthUser) error {
...
func (s *ProjectService) Update(ctx context.Context, user domain.AuthUser, project domain.Project) error {
...
func (s *ProjectService) Delete(ctx context.Context, user domain.AuthUser, projectID string) error {
...
func (s *ProjectService) ListMembers(ctx context.Context, user domain.AuthUser, projectID string) ([]domain.ProjectMember, error) {
...
func (s *ProjectService) AddMember(ctx context.Context, user domain.AuthUser, projectID string, identifier string, role string) error {
	if err := s.requireAdmin(ctx, projectID, user); err != nil {
		return err
	}
...
func (s *ProjectService) RemoveMember(ctx context.Context, user domain.AuthUser, projectID string, userID string) error {
	if err := s.requireAdmin(ctx, projectID, user); err != nil {
		return err
	}
