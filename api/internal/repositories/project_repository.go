...
func (r *ProjectRepository) ListByUser(ctx context.Context, userID string) ([]entities.Project, error) {
...
func (r *ProjectRepository) GetForUser(ctx context.Context, projectID string, userID string) (*entities.Project, error) {
	var p entities.Project
	var createdBy sql.NullString
