...
func (r *OAuthAccountRepository) Upsert(ctx context.Context, account entities.OAuthAccount) error {
...
func (r *OAuthAccountRepository) GetByProviderUserID(ctx context.Context, provider string, providerUserID string) (*entities.OAuthAccount, error) {
	var acc entities.OAuthAccount
...
func (r *OAuthAccountRepository) ListByUser(ctx context.Context, userID string) ([]entities.OAuthAccount, error) {
	...
	var items []entities.OAuthAccount
	for rows.Next() {
		var acc entities.OAuthAccount
		var expiry sql.NullTime
		if err := rows.Scan(
