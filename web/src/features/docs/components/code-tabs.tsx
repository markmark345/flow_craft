  ...
  return (
    <div className="rounded-xl border border-border bg-panel overflow-hidden shadow-soft">
      <div className="flex items-center justify-between gap-3 px-3 pt-3">
          ...
          {tabs.map((t) => {
            ...
            return (
              ...
              <Button
                ...
                className={cn(
                  "px-3 py-1.5 h-auto rounded-lg text-xs font-semibold transition-colors",
        ...
        <IconButton
          icon="content_copy"
          className="size-8 rounded-lg text-muted hover:text-text hover:bg-surface2 transition-colors"
          title="Copy"
          onClick={copyCode}
        />
      </div>
