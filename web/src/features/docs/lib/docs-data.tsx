      ...
      section(
        ...
        <>
          {prose(
            <>
              <p>
                FlowCraft uses API keys to authenticate requests. Authentication
                is performed via HTTP Basic Auth: pass your API key as the
                username. Password can be empty.
              </p>
              <p>
                Manage keys in{" "}
      ...
      section(
        ...
        <>
          {prose(
            <>
              <p>
                All URLs referenced in the documentation share this base URL:
              </p>
            </>
          )}
      ...
      section(
        ...
        <>
          {prose(
            <>
              <p>
                FlowCraft provides official open-source libraries to help you
                integrate our API into your codebase.
              </p>
            </>
          )}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
            <SdkCard
              title="Node.js"
              hint="npm install flowcraft"
              icon="terminal"
              tone="success"
            />
            <SdkCard
              title="Python"
              hint="pip install flowcraft"
              icon="terminal"
              tone="warning"
            />
            <SdkCard
              title="Go"
              hint="go get flowcraft"
              icon="terminal"
              tone="accent"
            />
          </div>
    ...
    sections: [
      section(
        ...
        prose(
          <>
            <p>
              Authentication to the FlowCraft API uses API keys. Use HTTP Basic
              Auth: API key as username and an empty password.
            </p>
          </>
        )
      ),
    ...
    sections: [
      section(
        ...
        prose(
          <>
            <p>
              API responses follow a common envelope. When an error occurs, the
              response contains an <code>error</code> object with{" "}
      ...
      section(
        ...
        prose(
          <>
            <p>
              Rate limiting is not enforced in the local dev API. For
              production, plan for standard retry/backoff for 429 and 5xx
              responses.
            </p>
          </>
        )
    ...
    sections: [
      ...
      section(
        ...
        prose(
          <>
            <p>
              Enter a condition string (for example:{" "}
              <code>order.total &gt; 500</code>). Condition evaluation is
              planned for a future milestone; currently it is treated as a
              configurable label.
            </p>
          </>
        )
